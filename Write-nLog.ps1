...
Write-nLog -Initialize -Type Info -Message "Testing" -SetLogLevel 1 -WriteHost -SetWriteHost $False -SetWriteLog $True
Start-PerformanceTest -ScriptBlock { Write-nLog -Type Debug -Message "Testing Time Spacer" } -Measurement Milliseconds -Iterations 10000
Write-nLog -Type Debug -Message "Testing234" -WriteHost
Write-nLog -Type Info -Message "Testing234" -WriteHost
Write-nLog -Type Warning -Message "Testing234" -WriteHost
Write-nLog -Type Error -Message "Testing234" -WriteHost
Write-nLog -Close -Message Test -Type Debug
